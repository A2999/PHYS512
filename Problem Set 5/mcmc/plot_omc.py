...
planck=np.loadtxt('Documents/Python Scripts/PHYS512/Problem Set 5/mcmc/COM_PowerSpect_CMB-TT-full_R3.01.txt',skiprows=1)
ell=planck[:,0]
spec=planck[:,1]
...
planck_binned=np.loadtxt('Documents/Python Scripts/PHYS512/Problem Set 5/mcmc/COM_PowerSpect_CMB-TT-binned_R3.01.txt',skiprows=1)
errs_binned=0.5*(planck_binned[:,2]+planck_binned[:,3]);
plt.clf()
plt.plot(ell,model)
#plt.errorbar(planck[:,0],planck[:,1],errs,fmt='.')
